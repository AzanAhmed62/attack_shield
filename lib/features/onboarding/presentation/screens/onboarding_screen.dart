  ...
  Future<void> _complete() async {
    ...
    try {
      ...
      final profile = OrganizationProfile(
        ...
        sector: _sector,
        orgSize: _orgSize,
        techStack: _techStack.map((e) => e.name).toList(),
        currentControls: _controls.isEmpty
            ? [SecurityControl.none.name]
            : _controls.map((e) => e.name).toList(),
      ...
      final applied =
          await ref.read(applyCoverageSuggestionsProvider.future);

      // Mark onboarding complete
      await GetStorage()
          .write(AppConstants.storageKeyOnboardingComplete, true);
      ...
      if (mounted) {
        ...
        if (applied > 0) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                  'Threat profile generated. $applied coverage entries pre-filled from your controls.'),
...
class _ProgressBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final labels = [
      'Welcome', 'ATT&CK', 'Use Case', 'Profile', 'Technology'
    ];
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _ExplCard(
            ...
            body: 'ATT&CK Defender uses this to measure what you\'re protected against — purely defensive, no hacking tools.',
          ),
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: [
          ...
          _UseCaseOption(
            ...
            desc: 'Student or security professional learning ATT&CK and defensive strategies.',
          ...
          _UseCaseOption(
            ...
            desc: 'Security lab, red/blue team exercises, or academic research.',
          ...
          _UseCaseOption(
            ...
            icon: Icons.business,
            label: 'Organization',
            desc: 'Mapping and improving your organization\'s defensive coverage against real-world threats.',
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Technology & Security Controls',
              style: Theme.of(context).textTheme.headlineMedium),
          const SizedBox(height: 6),
          Text(
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Security Controls You Already Have',
                  style: Theme.of(context).textTheme.titleMedium),
