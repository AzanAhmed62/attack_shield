                ...
                child: ListView(
                  ...
                  children: [
                    _StatusChip(
                      ...
                      current: filterStatus.value,
                      onTap: (v) => filterStatus.value = filterStatus.value == v
                          ? null
                          : v,
                    ),
                ...
                child: ListView(
                  ...
                  children: [
                    _PriorityChip(
                      label: 'All',
                      value: null,
                      current: filterPriority.value,
                      onTap: (_) => filterPriority.value = null,
                    ),
                    const SizedBox(width: 6),
                    _PriorityChip(
                      label: 'Critical',
                      ...
                      current: filterPriority.value,
                      onTap: (v) => filterPriority.value = v,
                    ),
                    const SizedBox(width: 6),
                    _PriorityChip(
                      label: 'High',
      ...
      body: alertsAsync.when(
        ...
        data: (alerts) {
          ...
          if (filterStatus.value != null) {
            filtered = filtered
                .where((a) => a.status == filterStatus.value)
                .toList();
          }
          if (filterPriority.value != null) {
            filtered = filtered
                .where((a) => a.priority == filterPriority.value)
                .toList();
          }
          ...
          return ListView.separated(
            ...
            itemBuilder: (_, i) => _AlertCard(
              ...
              onTechniqueOpen: filtered[i].effectiveLinkedTechniqueId != null
                  ? () => context.push(
                      '/library/${filtered[i].effectiveLinkedTechniqueId}',
                    )
                  : null,
            ),
          );
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              alert.effectiveLinkedTechniqueId!,
                              style: TextStyle(
                                fontSize: 10,
...
class _StatusChip extends StatelessWidget {
  ...
  final AlertStatus? current;
  final void Function(AlertStatus) onTap;
  const _StatusChip({
    required this.label,
    required this.value,
  ...
  Widget build(BuildContext context) {
    ...
    return FilterChip(
      label: Text(
        label,
        style: TextStyle(fontSize: 12, color: sel ? cs.primary : cs.onSurface),
      ),
      selected: sel,
...
class _PriorityChip extends StatelessWidget {
  ...
  final void Function(AlertPriority?) onTap;
  const _PriorityChip({
    required this.label,
    required this.value,
    required this.current,
