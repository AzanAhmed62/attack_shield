          ...
          riskReport.when(
            data: (r) => Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    '${r.coveragePercent.toStringAsFixed(0)}% covered',
                    style: TextStyle(
                      fontSize: 12,
                  ...
                  Text(
                    'Risk: ${r.orgRiskScore.toStringAsFixed(0)}/100',
                  ...
                  sliver: SliverList.builder(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      final partial = techs
                          .where(
                            (t) =>
                                covMap[t.id] == CoverageLevel.partiallyCovered,
                          )
                          .length;
                      final pct = techs.isEmpty
                          ? 0.0
...
class _TacticAccordion extends HookWidget {
  ...
  Widget build(BuildContext context) {
    final expanded = useState(
      coveragePct < 0.8,
    ); // auto-expand incomplete tactics
    final cs = Theme.of(context).colorScheme;
